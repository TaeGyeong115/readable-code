...
public class StudyCafePassMachine {
    ...
    private Optional<StudyCafeLockerPass> selectLockerPass(StudyCafePass selectedPass) {
        ...
        StudyCafeLockerPass localPassCandidate = findLockerPassCandidateBy(selectedPass);
        if (localPassCandidate != null) {
            boolean isLockerSelected = ioHandler.askLockerPass(localPassCandidate);

            if (isLockerSelected) {
                return Optional.of(localPassCandidate);
            }
        }
